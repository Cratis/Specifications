...
public class and_nunit_test_method_is_not_named_should : given.a_fact_method_should_naming_analyzer
{
    const string Usage = """
    public class when_doing_something : Cratis.Specifications.Specification
    {
        [NUnit.Framework.Test] void {|#0:it_works|}() { }
    }
    """;
    ...
    [Fact] Task should_report_the_naming_diagnostic_for_nunit_too() => _result;
}
