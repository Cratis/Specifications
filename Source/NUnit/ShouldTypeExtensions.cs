...
public static class ShouldTypeExtensions
{
    ...
    public static void ShouldBeAssignableFrom<T>(this object actual) => Assert.That(actual, Is.AssignableFrom<T>());
    ...
    public static void ShouldBeAssignableFrom(this object actual, Type expected) => Assert.That(actual, Is.AssignableFrom(expected));
    ...
    public static void ShouldBeOfExactType<T>(this object actual) => Assert.That(actual, Is.TypeOf<T>());
}
